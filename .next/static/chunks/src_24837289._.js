                    ...
                    try {
                        ...
                        const mockServiceContent = {
                            'consultas-ocupacionais': {
                                ...
                                longDescription: 'Realização de consultas médicas ocupacionais diretamente nas empresas para avaliação da saúde dos trabalhadores proporcionando maior conforto e praticidade, além de garantir a promoção de saúde e cumprimento das disposições legais vigentes.',
                            ...
                            'consultoria-medica': {
                                ...
                                longDescription: 'Orientação especializada sobre questões relacionadas à saúde ocupacional e gestão de risco com o objetivo de proporcionar a conformidade com normas de segurança e saúde, além de prevenção de doenças e acidentes.',
                            ...
                            'assistencia-tecnica': {
                                ...
                                longDescription: 'Suporte médico especializado em processos judiciais, fornecendo pareceres, laudos e esclarecimentos técnicos em casos relacionados à saúde.',
                            ...
                            'elaboracao-quesitos': {
                                ...
                                longDescription: 'Desenvolvimento de perguntas técnicas e objetivas para perícias médicas, visando esclarecer pontos fundamentais do caso.',
                                icon: '/images/icons/medical-exam-icon.svg'
                            },
                            tutoria: {
                                ...
                                longDescription: 'Treinamento especializado para profissionais da área de Medicina do Trabalho e Perícias Médicas.',
                            ...
                            palestras: {
                                ...
                                longDescription: 'Sessões educativas e personalizadas sobre saúde ocupacional, prevenção de doenças e segurança no trabalho.',
